...
import com.jd.business.adapter.CommonTabPagerAdapter;

/**
 * 商品详情
 * Created by weip on 2019/3/1.
 */

public class ShopListActivity extends AppCompatActivity implements CommonTabPagerAdapter.TabPagerListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewpager = (ViewPager) findViewById(R.id.module_activity_shoplist_viewpager);
